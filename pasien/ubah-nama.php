...
<div class="container">
        ...
        <div class="konten">
            ...
            <div class="kotak1">
                ...
                <input type="text" name="nama" class="input" value="<?=$tampil->nama_pasien;?>" >
                ...
                <a class="password" href="ubah-password.php" target="_self">Ingin Ubah Password?</a>
                <div class="kotak2">
            ...
            if(isset($_POST['Ganti'])){
                ...
                $nama = $_POST['nama'];
                $update = "UPDATE pasien SET  nama_pasien='$nama', username='$username' where id_pasien='$_SESSION[id]'";
